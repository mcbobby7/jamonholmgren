  ...
  return (
    <Page title="Beginnings">
      ...
      <p>
        ...
        Vietnam). The house was situated on about eight acres and was bordered
      ...
      <p>
        Unfortunately for me, the 286 didn't come with any programming tools.
      ...
      <p>
        Besides computer programming and computer games, I loved to read. I read
        a lot of sci-fi and fantasy, including the Wheel of Time series, and a
        lot of World War II nonfiction, especially about airplanes and
        submarines. I'd ride the bus into town with my long legs folded against
        the seat in front of me, engrossed in yet another library book.
      </p>
      <p>
        I played varsity basketball in high school. I was 6'-4" and somewhat
        athletic, so the coach convinced me to try out for the team despite me
        being a complete rookie on the court. Within a few months I was hooked.
        I still love to play basketball, although the opportunities are fewer
        and further between.
      </p>
      <p>
        After high school, I tried out for a local community college basketball
        team and practiced with them up until I was cut just before their first
        game. I finished out the semester and then moved to Vancouver,
      ...
      <p>
        ...
        both of my homes,{" "}
        <Link href="http://www.newtraditionhomes.com">New Tradition Homes</Link>).
        I did CAD design and marketing for them for a few years.
      </p>
      <p>
        My wife Chyra and I got married during that time and had our first of
        four children, Cedric.
      </p>
      <img
      ...
      <p>
        ...
        <Link href="https://clearsightstudio.com">ClearSight</Link>, designing
        and programming small business websites.
      </p>
      <p>
        Running my own business was really eye-opening to me. When I started, I
        literally went from office park to office park, handing out business
        cards to whoever would listen to me. I got a few contracts that way and
        developed some sales skills that have helped me a lot. I also had to
        learn PHP, databases, and user experience design. Luckily, expectations
        were low!
      </p>
      <img
      ...
      <p>
        After a few years, I started feeling like I needed some help. I
        eventually hired a few people including a junior developer, Kevin
        VanGelder, who is still with my company to this day. Over the next
        several years, I grew the business from just me to a dozen, including a
        project manager, design department, and many developers to share the
        load. We went from small business websites to larger web applications
      ...
      <p>
        ...
        <Link href="https://infinite.red">Infinite Red</Link>.
      </p>
      <p>
      ...
      <p className="next-steps">
        <em>
          <Link href="/now" prefetch>
            Read more about what I'm doing now
          </Link>
        </em>
        &bull;
        <em>
          <Link href="/tech" prefetch>
            Check out the tech I'm currently working in or exploring
          </Link>
        </em>
        &bull;
        <em>
          <Link href="/archive" prefetch>
            Archive of old blog posts I've kept around
          </Link>
        </em>
      </p>
      <style jsx>{`
