...
export default () => {
  return (
    <Page title="Annoying iOS issues: ApplicationVerification Failed">
      ...
      <p>
        <em>Published November 13, 2014</em>
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2014-11-13_at_5.51.01_PM.png?+"
          alt="Xcode menu showing Devices selected"
        />
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/2014-11-13-gd856.png?+"
          alt="Hidden icon for console on bottom left"
        />
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/2014-11-13-07oje.png?+"
          alt="Click *just above* the icon and drag upward"
        />
      </p>

      <p>
        Once we tried <code>rake device</code> again, there was a line that said
        something to the effect that there were some entitlements that were not
        allowed with this provisioning profile. Ah-ha!
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/2014-11-13-e69cl.png?+"
          alt="Showing HealthKit is off"
        />
      </p>

      <p>
        After turning that on and regenerating the provisioning profile,
        everything worked.
      </p>
      ...
      <p>
        <strong>UPDATE 11/18/2014:</strong>
      </p>

      <p>We ran into another error:</p>

      <pre>
        <code>Failed to create source for client (null)</code>
      </pre>
