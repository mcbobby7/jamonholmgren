...
export default () => {
  return (
    <Page title="What the hex?">
      <h1>What the hex?</h1>
      <p>
        <em>Published January 30, 2015</em>
      </p>

      <p>
        We all know it's not a good idea to commit secret API keys into your git
        repository. For RubyMotion, it's tempting to do so anyway, since the
        code will be compiled into a binary.
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_8.40.15_AM.png?+"
          alt="my_happy_app"
        />
      </p>

      <h5 id="2addanapikeyinyourappdelegate">
        2. Add an API key in your app delegate.
      </h5>

      <pre>
        <code class="ruby language-ruby">{`class AppDelegate
      ...
      <pre>
        <code>$ rake archive `}</code>
      </pre>

      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_8.52.17_AM.png?+"
          alt="binary"
        />
      </p>

      <h5 id="4openupthatipafileandextractitwitharchiveutility">
        4. Open up that IPA file and extract it with Archive Utility
      </h5>

      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_8.54.08_AM.png?+"
          alt="extracting"
        />
      </p>
      ...
      <p>
        Go into the <code>Payload</code> folder, right-click on the app and Show
        Package Contents. You should see something like this:
      </p>

      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_8.57.28_AM.png?+"
          alt="happy app"
        />
      </p>
      ...
      <p>
        I use <a href="http://ridiculousfish.com/hexfiend/">Hex Fiend</a>.
      </p>

      <h5 id="7openthebinaryinhexfiend">7. Open the binary in Hex Fiend</h5>

      <p>
        Choose File -> Open, then drag the binary from Finder into your file
        dialog, which will pre-select it. I use this trick all the time in OSX.
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_8.59.37_AM.png?+"
          alt="hex fiend"
        />
      </p>
      ...
      <p>
        If you can find it that easily, someone else could scan through the
        binary and find it too.
      </p>

      <p>
        <img src="http://clrsight.co/jh/2015-01-30-6pqr0.png?+" alt="uh-oh" />
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_9.10.35_AM.png?+"
          alt="yay not"
        />
      </p>

      <h5 id="arentmyappsprotectedbytheappstore">
      ...
      <p>
        Your best option is probably obfuscation -- make it harder on the
        hacker. Here's a very simplistic example.
      </p>

      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_10.24.25_AM.png?+"
          alt="base64"
        />
      </p>
      ...
      <p>
        <img
          src="http://clrsight.co/jh/Screen_Shot_2015-01-30_at_10.23.25_AM.png?+"
          alt="decoded"
        />
      </p>
      ...
      <p>
        This is by no means foolproof. Someone could see that string, deduce
        that it's a Base64-encoded string (especially by the method calls around
        it), and just run their own Base64 decoder on it. So you'll want to
        devise your own clever obfuscation strategies.
      </p>

      <p>
        <strong>
          Have any other iOS API key security tips? I'd love to hear them. Hit
          me up <a href="https://twitter.com/jamonholmgren">on Twitter</a>.
        </strong>
      </p>
