...
export default () => {
  return (
    ...
    >
      ...
      <p>
        <em>
          This is a webpage version of the Twitter thread I did about the pool.
          Enjoy!
        </em>
      </p>

      <TweetEmbed id="1157778057018535936" />

      <p>So, last year we installed an above-ground 18' pool.</p>
      <p>
        I had my brother-in-law flatten out an area 25' in diameter, though,
        because I figured if this experiment went well we might want to upgrade
        to a 24' sometime later when the pool needed to be replaced.
      </p>
      <a
        href="/static/pool/image12.jpg"
        target="_blank"
      ...
      <p>
        I struggled to keep the water from getting murky, because I was a pool
        newbie who doesn't read directions very well.
      </p>
      <p>(In the second photo, you can see the water is too green.)</p>
      <a
        href="/static/pool/image74.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        pool the rest of the time.
      </p>
      <p>
        But then another rookie mistake: I entirely emptied my pool before
        winter, thinking that was the best thing to do.
      </p>
      <p>There was a windstorm in December and the pool collapsed.</p>
      <a
        href="/static/pool/image51.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        2.Ground water &mdash; we are perilously close to the water table, and
        it didn't seem like a good idea to tempt fate by digging a huge hole.
      </p>
      <p>
        But then Chyra started researching above ground pool decks. And it
        started making sense to go that route.
      </p>
      <p>
        Her brother builds decks but is always super busy. But! He was waiting
        for a big project to start. We got lucky.
      </p>
      <p>
        Doing a full deck around the whole thing would be cool, but also pretty
        expensive ($30-40k by itself). Instead, we decided to build it halfway
        around the pool. This saved nearly half of that.
      </p>
      <p>
        So my other bro-in-law came back (it pays to have brothers-in-law in
        construction) and dug it out.
      </p>
      <p>
        We went down 18" into the soil to sink the pool down and keep the deck
        height from being too high off the ground, which would look strange.
      </p>
      <a
        href="/static/pool/image57.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        <a href="https://twitter.com/ThePoolFactory">@ThePoolFactory</a>. The
        truck came in, I backed my trailer up to it, and the driver dropped it
        right on the trailer.
      </p>
      <p>
        It's <strong>heavy</strong>.
      </p>
      <a
        href="/static/pool/image72.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        The outside posts are 6'-0" on center (183 cm in non-freedom-units). The
        inside is carefully measured off the centerpoint to follow outside the
        outer wall of the pool.
      </p>
      <p>He built it very rugged. This thing could support an elephant.</p>
      <p>
        (Some of the supports in these photos are temporary and will be cut and
        attached more permanently.)
      </p>
      <a
        href="/static/pool/image47.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        <a href="https://twitter.com/timbertechABP">@timbertechABP</a> Trex-like
        composite decking. It can't span quite as far, but it is super durable.
      </p>
      <a
        href="/static/pool/image85.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        feel right, so we extended it with these wings. (Chyra did a great job
        with design all the way through.)
      </p>
      <p>The decking went on steadily over the course of several days.</p>
      <a
        href="/static/pool/image90.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        It's a little overgrown, although I did see the neighbor working on it
        today, which is nice to see.
      </p>
      <p>
        With the decking done, Walt (BIL) cut the inner curve of the pool edge
        off the decking, and it started looking like a deck!
      </p>
      <a
        href="/static/pool/image33.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        like the rest of the deck that it's well-built.
      </p>
      <a
        href="/static/pool/image88.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        the foot of the stairway. I think we'll need to do something about it. I
        hate to lose the flowers for the bees but can't have my barefoot kids
        getting stung.
      </p>
      <a
        href="/static/pool/image7.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        the skirting and some other odds and ends), it was time to level out the
        sand and get it up to grade. A screed board around a central point works
        well for this.
      </p>
      <a
        href="/static/pool/image77.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        Everything he does is within fractions of an inch &mdash; a real
        craftsman. He also tamped down the sand to compact it.
      </p>
      <a
        href="/static/pool/image71.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        &mdash; took all 4 of us.
      </p>
      <a
        href="/static/pool/image97.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        bolts) onto both ends of the wall.
      </p>
      <p>We screwed up a few times and had to redo it.</p>
      <a
        href="/static/pool/image82.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        wouldn't fit to the new pool's skimmer and outlet jet but it did. I was
        pretty happy about that.
      </p>
      <a
        href="/static/pool/image17.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        one. He's still pretty new to it so it took quite a few tries. In the
        end he bought a 1-1/4" PVC end cap and it fit perfectly, so I didn't get
        to use his 3D printed one. Oh well.
      </p>
      <a
        href="/static/pool/image16.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        3" of sand in the bottom *inside* the pool wall (doesn't make sense to
        me). So I'm waiting for a load of sand Monday from my sand guy.
      </p>
      <p>I'll also call The Pool Factory and see if it's strictly necessary.</p>
      <a
        href="/static/pool/image15.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        behind a bunch of young sequoias. Walt will bring a tractor here and use
        it to dump more sand in the pool bottom.
      </p>
      <a
        href="/static/pool/image95.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        Walt had called{" "}
        <a href="https://twitter.com/ThePoolFactory">@ThePoolFactory</a> but
        they said you absolutely need the 3" of sand in the bottom. Bummer; this
        isn't really a 54" pool then, if you lose 3" of the bottom.
      </p>
      <p>
      ...
      <p>
        ...
        to tighten it as we fill the pool.
      </p>
      <a
        href="/static/pool/image76.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        Up to 3"! About an inch per hour which seems like 48 hours will be about
        right.
      </p>
      <a
        href="/static/pool/image45.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        that we *had* to put the 3" of additional sand in the bottom, but based
        on how much liner overlap we have on the walls, we definitely could have
        done without that. (We already had 3" as a base.) We could have gotten
        2-3" of additional depth. 😒
      </p>
      <a
        href="/static/pool/image116.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        lawnmower with a trailer so I can haul it to the street.
      </p>
      <p>
        If you have a riding mower, I recommend getting one of these trailers. I
        use it all the time, for hauling dirt, bark dust, rock, packages, etc.
      </p>
      <a
        href="/static/pool/image39.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        of filter sand. The trailer hitch rack works well for this, although I
        put some of them inside the Wrangler.
      </p>
      <a
        href="/static/pool/image110.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        it. I did turn it on with hose input and it worked, so that's cool. I
        had to do some modifications to get the pump to attach properly (it
        isn't for this pool) but no leaks that I can see!
      </p>
      <a
        href="/static/pool/image91.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        prevent our being attacked ferociously.
      </p>
      <a
        href="/static/pool/image34.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        Trying not to fall in as I dump 40lb bags of salt in. Even with
        quick-dissolving pool salt it still settles on the bottom. I'll have to
        use the brush/squeegee to mix it up.
      </p>
      <a
        href="/static/pool/image105.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        Just shut off the water. Just under 48 hours of filling to hit the level
        we want.
      </p>
      <p>
        Salt level is 2045 PPM. We need to hit 3000-3200. The ocean is something
        like 30,000 PPM, so you won't really taste any salt in this water.
      </p>
      <a
        href="/static/pool/image68.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        warm it while we are gone.
      </p>
      <a
        href="/static/pool/image69.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        A bit chilly but they don't care. I'll take off the solar cover.
      </p>
      <p>Going to need better storage for the cover than this.</p>
      <a
        href="/static/pool/image2.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        bit cold but swimmable.
      </p>
      <p>(Skirting is only about half done.)</p>
      <a
        href="/static/pool/image61.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        ...
        easier to swim in now.
      </p>
      <a
        href="/static/pool/image49.jpg"
        target="_blank"
        className="image-wrapper"
      >
        <img
      ...
      <p>
        <em>
          That's it for now! I'll add more to{" "}
          <a href="https://twitter.com/jamonholmgren/status/1162166538683633665">
            the Twitter thread
          </a>
          , but probably won't bring it back to this page. I hope you enjoyed
          this and please let me know via email (jamonholmgren at gmail) or on
